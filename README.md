# Sistema de monitoreo smarthome basado en enlaces Zigbee 

Sistema de monitoreo para un inmueble del tipo vivienda.

Este inmueble se encuentra provisto de distintos tipos de dispositivos y un servidor
backend. Dicho servidor backend se encuentra conectado inalámbricamente mediante el
protocolo Zigbee a un conjunto de sensores electrónicos. Los sensores son de tres tipos:
infrarrojo, electroquímico, magnético y se activan ante la presencia de un posible riesgo
para el inmueble o las personas que la habitan.

Al detectar una amenaza, el sensor se activa y comunica inalámbricamente con
servidor, éste procesa las señales recibidas e identifica si la activación corresponde a un
intruso, un incendio o gas nocivo.

## Vista rapida

```sh
git clone https://github.com/DivingIoT/TFC.git
cd TFC
npm install
npm start
```

Luego abra [http://localhost:3000/](http://localhost:3000/) para ver la app.<br>
